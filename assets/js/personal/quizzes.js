...
/* ==========================================================================
   ROFILID Full Financial Fitness Challenge Scripts - v1.0.0
   Description: Scripts exclusive to the main Quizzes page (quizzes.html).
                Handles loading all quiz categories and managing the quiz modal.
                Uses the full question dataset.
   NOTE: Relies on the modal HTML structure from quizzes.html/personal.html
         and shared styles from personal.css.
         Does NOT include the "Next Quiz" button logic or the "Full Challenge Prompt".
   ========================================================================== */

document.addEventListener('DOMContentLoaded', () => {

    console.log("Rofilid Quizzes Page Script Initialized.");
    ...
    const fullQuizData = [
        ...
        // Category 5: Understanding Credit & Debt (Mapped to Theme 1 based on HTML structure)
        ...
        // Category 6: Goal Setting & Planning (Mapped from Text Theme 2 - Cat 5)
        ...
        // Category 7: Banking & Financial Institutions (Mapped from Text Theme 2 - Cat 7)
        ...
        // Category 8: Financial Risk Management (Mapped from Text Theme 3 - Cat 8)
        ...
        // Category 9: Understanding Financial Advice (Mapped from Text Theme 3 - Cat 9)
        ...
        // Category 10: Tax Basics (Mapped from Text Theme 3 - Cat 10)
        ...
        // Category 11: Introduction to Investing (Mapped from Text Theme 4 - Cat 11)
        ...
        // Category 12: Investment Types (Basic) (Mapped from Text Theme 4 - Cat 12)
        ...
        // Category 13: Risk vs. Return (Mapped from Text Theme 4 - Cat 13)
        ...
        // Category 14: Time Value of Money (Mapped from Text Theme 4 - Cat 14)
        ...
        // Category 15: Behavioral Finance Intro (Mapped from Text Theme 5 - Cat 15)
        ...
        // Category 16: Insurance Basics (Mapped from Text Theme 5 - Cat 16)
        ...
        // Category 17: Identity Theft & Fraud (Mapped from Text Theme 5 - Cat 17)
        ...
        // Category 18: Retirement Planning Intro (Mapped from Text Theme 6 - Cat 18)
        ...
        // Category 19: Major Purchase Planning (Mapped from Text Theme 6 - Cat 19)
        ...
        // Category 20: Estate Planning Basics (Mapped from Text Theme 6 - Cat 20)
    ...
    // References to elements not used on this page but present in modal HTML
    ...
    // --- Core Modal Functions (Same as used previously) ---
    function startQuiz(categoryId) {
        ...
        if (categoryQuestions.length === 0) {
            ...
            alert("Sorry, questions for this category could not be loaded. The data might be missing.");
            return;
        }
    ...
    document.querySelectorAll('#full-financial-challenge .start-quiz-btn').forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            if (categoryId) {
                quizTriggerElement = e.target; startQuiz(categoryId);
            } else {
                console.error("Missing or invalid category ID on card."); alert("Could not load the selected quiz.");
            }
        });
    });
    ...
    // No listener for Next Quiz button needed here
    if (quizModal) {
